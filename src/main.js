...
/* Cargo parity settlement: every producer/consumer has an adjacent road flag. */
for(let x=7;x<=22;x++)road(x,13);for(let y=8;y<=19;y++)road(14,y);
road(9,13,'flag');road(11,13,'flag');road(14,13,'flag');road(16,13,'flag');road(19,13,'flag');road(14,9,'flag');road(14,15,'flag');road(14,18,'flag');
add('wood',9,12);add('mill',11,12);add('quarry',19,12);add('store',13,15);add('farm',15,18);add('house',12,15);
